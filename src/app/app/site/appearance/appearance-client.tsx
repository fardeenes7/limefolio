        ...
        <Page>
            <PageHeader>
                <PageHeading>
                    ...
                    <PageDescription>
                        Choose your portfolio's template, color theme, and typography
                    </PageDescription>
                </PageHeading>
                <PageAction>
            ...
            <PageBody>
                <form id="appearance-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    {/* ── Template ──────────────────────────────────────────────── */}
                                            ...
                                            {THEMES_META.map((theme) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "relative flex items-center gap-4 rounded-xl border px-4 py-3.5 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                                                            isSelected
                                            ...
                                            {FONTS_META.map((font) => {
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        className={cn(
                                                            "relative flex flex-col gap-1.5 rounded-xl border px-4 py-4 text-left transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary",
                                                            isSelected
                                                                ? "border-primary bg-primary/5 ring-1 ring-primary"
                                                                : "border-border hover:border-primary/40 hover:bg-muted/40",
                                                        )}

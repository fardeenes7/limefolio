...
import { Facebook, XIcon, Github, Linkedin } from '@/components/icons';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Empowering creatives to showcase their best work and build their
              professional brand.
            </p>
        ...
        <div className="mt-8 py-8 border-t border-gray-200 dark:border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <p className="md:text-right text-sm text-gray-500 dark:text-gray-400 flex items-center">
              Made with{' '}
              <Heart className="h-4 w-4 fill-red-500 text-red-500 mx-1" /> by{' '}
              <Link
